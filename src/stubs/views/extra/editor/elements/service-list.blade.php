                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td contenteditable="true" style="text-align:center">
                            ...
                            <img border="0" class="content-image" src="{{asset('public/editor/assets/images/service-list/lamp.png')}}" style="display: inline-block;margin: 0px;width:64px;height:64px">
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td contenteditable="true" style="text-align:center">
                            ...
                            <img border="0" class="content-image" src="{{asset('public/editor/assets/images/service-list/comp.png')}}" style="display: inline-block;margin: 0px;width:64px;height:64px">
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td contenteditable="true" style="text-align:center">
                            ...
                            <img border="0" class="content-image" src="{{asset('public/editor/assets/images/service-list/code.png')}}" style="display: inline-block;margin: 0px;width:64px;height:64px">
                        </td>
                    </tr>
                    <tr>
                        <td>
